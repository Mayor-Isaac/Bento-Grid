  ...
  return (
    <div className="App">
      <Grid imgUrl="images/illustration-create-post.webp"
        ...
        imgAlt="Five stars Illustration"  w="200" h="30" ps={2} bg="#7650dc" column="2/4" afterText="Over 4,000 5-star reviews" text="white" > Social Media <span style={{color:"#ffcb6b"}}>10x</span> 
